...
function FormSection({ legend, children }: Readonly<FormSectionProps>) {
  return (
    <fieldset className="min-w-0">
      <legend className="mb-4 text-[15px] font-semibold tracking-tight text-zinc-900">
        {legend}
      </legend>
      {children}
    </fieldset>
...
export function RenterProfileForm() {
  ...
  return (
    <form
      ...
      className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-[0_2px_10px_-6px_rgba(24,24,27,0.10)]"
    >
      ...
      <div className="border-t border-zinc-200 px-6 py-4 sm:px-8">
        {savedSnapshot !== null ? (
          <output className="mb-3 block rounded-xl bg-zinc-100 px-4 py-3 text-sm leading-relaxed text-zinc-700">
        ...
        <div className="flex flex-col-reverse items-stretch gap-3 sm:flex-row sm:items-center">
          ...
          <button
            ...
            className="inline-flex items-center justify-center rounded-full px-4 py-2 text-sm font-semibold text-zinc-600 transition-colors hover:text-zinc-900 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-500"
          >
            Cancel
          </button>
        </div>
