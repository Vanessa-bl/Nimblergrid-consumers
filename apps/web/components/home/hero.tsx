...
const HERO_STATS = [
  { value: "9.6k+", label: "Profesionales" },
...
export function Hero() {
  return (
    <section className="mx-auto grid max-w-[1640px] items-center gap-10 px-4 pt-12 pb-12 sm:px-6 lg:grid-cols-[1.05fr_1fr] lg:gap-14 lg:px-7 lg:pt-16 lg:pb-14">
      <div>
        <Eyebrow>La plataforma de arquitectura y diseño AR</Eyebrow>
        <h1 className="mt-4 font-sans text-4xl font-semibold leading-[1.05] tracking-tight text-zinc-900 sm:text-5xl lg:text-[58px]">
          Rent, buy or sell your{" "}
          <em className="not-italic text-rose-500">Property</em> in the UE
        </h1>
        <p className="mt-5 max-w-[52ch] text-[17px] leading-[1.6] text-zinc-600">
          Inspirate con miles de proyectos reales, encontrá el estudio adecuado
          para tu obra y descubrí productos verificados — todo en un mismo
          lugar.
        </p>
        ...
        <p className="mt-6 flex items-center gap-2 text-[13.5px] text-zinc-500">
          <span
            ...
            aria-hidden="true"
          />
          <b className="font-semibold text-zinc-900">9.600+</b> estudios
          verificados y <b className="font-semibold text-zinc-900">202.000+</b>{" "}
          fotos
        </p>
      </div>
      ...
      <div className="relative mx-auto w-full max-w-[520px] lg:max-w-none">
        <div className="relative aspect-[4/3.4] overflow-hidden rounded-[28px] bg-[linear-gradient(150deg,#E7DBD9,#CBB6B4)] shadow-[0_10px_30px_-12px_rgba(15,23,42,0.25)]">
          <Image
            src="https://ik.imagekit.io/bedpw9jglo5/photos/f/fcqsqozl.jpg?tr=w-1080,h-920,fo-auto"
