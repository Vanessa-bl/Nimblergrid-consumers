...
const toneClasses: Record<AvatarTone, string> = {
  ...
  light: "border border-zinc-200 bg-white text-zinc-700",
  muted: "border border-zinc-200 bg-zinc-200 text-zinc-700",
};

const imageClasses = "border border-zinc-200 bg-zinc-100";
