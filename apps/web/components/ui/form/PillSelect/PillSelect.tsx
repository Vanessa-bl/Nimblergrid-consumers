...
const basePillClasses =
  "inline-flex h-9 cursor-pointer select-none items-center rounded-full border px-3.5 text-sm font-medium transition-colors duration-150 has-[:focus-visible]:outline-2 has-[:focus-visible]:outline-offset-2 has-[:focus-visible]:outline-brand-500";

const pillStateClasses: Record<"idle" | "selected" | "disabled", string> = {
  idle: "border-neutral-200 bg-white text-neutral-700 hover:border-neutral-400 hover:text-neutral-900",
  selected: "border-transparent bg-neutral-900 font-semibold text-white",
  disabled: "cursor-not-allowed border-neutral-200 bg-white text-neutral-400 opacity-60",
};
