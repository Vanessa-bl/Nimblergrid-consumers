...
import type { UserProfileData } from "./UserProfileCard.types";
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        ...
        className="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-[0_20px_50px_-20px_rgba(24,24,27,0.35)]"
      >
        <div className="flex items-start justify-between gap-4">
          ...
          <button
            ...
            aria-label="Cerrar"
            onClick={onClose}
            className="inline-flex h-9 w-9 items-center justify-center rounded-full text-zinc-400 transition-colors hover:bg-zinc-100 hover:text-zinc-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-500"
          >
        ...
        <div className="mt-6 flex items-center justify-end gap-3">
          <button
            type="button"
            onClick={onClose}
            className="inline-flex items-center justify-center rounded-full px-4 py-2.5 text-sm font-semibold text-zinc-600 transition-colors hover:text-zinc-900 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-500"
          >
            Cancelar
          </button>
